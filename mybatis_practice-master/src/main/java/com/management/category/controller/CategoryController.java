...
public class CategoryController {
    ...
    public void registNewCategory(CategoryDTO category) {
        ...
        boolean insertCategory = categoryService.registNewCategory(category);

        if(insertCategory) {
            categoryPrint.printSuccessMessage("successCategoryInsert");
        } else {
            categoryPrint.printErrorMessage("failCategoryInsert");
        }
    }
    ...
    public void modifyCategoryName(CategoryDTO category) {
        ...
        boolean updateCategory = categoryService.modifyCategoryName(category);

        if(updateCategory) {
            categoryPrint.printSuccessMessage("successCategoryUpdate");
        } else {
            categoryPrint.printErrorMessage("failCategoryUpdate");
        }
    }
    ...
    public void deleteCategory(Map<String, String> parameter) {
        ...
        boolean deleteCategory = categoryService.deleteCategory(parameter);

        if(deleteCategory) {
            categoryPrint.printSuccessMessage("successCategoryDelete");
        } else {
            categoryPrint.printErrorMessage("failCategoryDelete");
        }
    }
}
