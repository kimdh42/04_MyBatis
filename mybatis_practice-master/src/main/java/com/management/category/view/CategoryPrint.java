...
public class CategoryPrint {
    ...
    public void printSuccessMessage(String successCode) {
        ...
        String successMasage = "";
        switch (successCode) {
            case "successCategoryInsert" : successMasage = "제품분류 정보 등록에 성공하였습니다."; break;
            case "successCategoryUpdate" : successMasage = "제품분류 정보 수정에 성공하였습니다."; break;
            case "successCategoryDelete" : successMasage = "제품분류 정보 삭제에 성공하였습니다."; break;
        }
        System.out.println(successMasage);
    }
    ...
    public void printErrorMessage(String errorCode) {
        ...
        switch (errorCode) {
            ...
            case "failCategoryInsert" : errorMessage = "제품분류 정보 등록에 실패하였습니다."; break;
            case "failCategoryUpdate" : errorMessage = "제품분류 정보 수정에 실패하였습니다."; break;
            case "failCategoryDelete" : errorMessage = "제품분류 정보 삭제에 실패하였스니다."; break;
        }
