...
public class ProductController {
    ...
    public void selectProductByCondition(SearchCondition searchCondition) {
        ...
        if(productList != null) {
            ...
            productPrint.printErrorMessage("productByCondition");
        }
    }
    ...
    public void registNewProduct(ProductDTO product) {
        ...
        int salesQuantity = 0;
        product.setSalesQuantity(String.valueOf(salesQuantity));

        boolean successInsertProduct = productService.registNewProduct(product);

        if(successInsertProduct) {
            productPrint.printSuccessMessage("successInsert");
        } else {
            productPrint.printErrorMessage("failInsert");
        }
    }
    ...
    public void modifyProductInfo(ProductDTO product) {
        ...
        boolean successUpdateProduct = productService.modifyProductInfo(product);

        if(successUpdateProduct) {
            productPrint.printSuccessMessage("successUpdate");
        } else {
    ...
    public void deleteProduct(Map<String, String> parameter) {
        ...
        boolean successDeleteProduct = productService.deleteProduct(parameter);
