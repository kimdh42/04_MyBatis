...
public class Application {
    public static void main(String[] args) {
        ...
        do{
            ...
            switch (no) {
                ...
                case 3 : elementTestService.selecSqlTest(); break;
    ...
    private static void resultMapSubMenu() {
        ...
        Scanner sc = new Scanner(System.in);
        ElementTestService elementTestSevice = new ElementTestService();
        ...
        do{
            ...
            switch (no) {
                case 1 : elementTestSevice.selectResultMapTest(); break;
                case 2 : elementTestSevice.selectResultMapConstructorTest(); break;
                case 3 : elementTestSevice.selectResultMapAssociationTest(); break;
                case 4 : elementTestSevice.selectResultMapCollectionTest(); break;
            }
        } while (true);
    }
    private static MenuAndCategoryDTO inputMenuAndCategory() {
        ...
        menuAndCategory.setCatogory(category);
